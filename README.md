...
## 📖 Overview
This project explores the design, training, and evaluation of Convolutional Neural Networks (CNNs) for hand gesture classification ("Rock", "Paper", "Scissors"). Three models of incremental complexity were developed: a shallow baseline, a deep unregularized network, and a deep regularized network utilizing Dropout and Hyperband tuning. 
...
```text
├── data/                   # (Not included in repo) Training and custom OOD images
├── models/                 # Saved .keras models (Model 1, 2, and 3)
